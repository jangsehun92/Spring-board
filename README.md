...
게시판 조건
  ...
  - 허용 가능한 값(카테고리, 게시글 중요도)을 제한하기 위해 Enum클래스를 활용한다.
  - 게시글 작성은 로그인을 해야 작성할 수 있다.
  - 게시글 수정,삭제는 해당 글을 작성한 계정 또는 관리자 권한을 가지고 있어야한다.
  - 관리자는 게시글 작성,수정,삭제와 다른 유저가 작성한 게시글을 수정,삭제 할 수 있다.
...
댓글 조건
  ...
  - 댓글 입력은 로그인을 하여야 가능하다.
  - 해당 댓글 수정,삭제 요청은 댓글을 작성한 계정 또는 관리자 권한을 가지고 있어야 한다.
  - 관리자는 댓글 작성,수정,삭제와 다른 유저가 작성한 댓글을 수정,삭제 할 수 있다.
