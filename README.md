...
| 인증 이메일 재발송 |GET /account/resend?email={}|email=[String]|N/A|Status 200 OK|<ui><li> Bad Request - 400 { "message":"잘못된 요청입니다.","status":400,"code":"C006","errors":[]} </li></ui>|
...
|계정 정보 변경|PATCH /account/{id}|id=[Integer]|{ "nickname" : "newNick" }|Status 200 OK|<ui><li>Entity Not Found - 400 { code: "C003", errors: [{field: "nickname", value: "", reason: "닉네임을 입력해주세요."}], message: " Entity Not Found", status: 400</li></ui>|
## 게시판
게시판 조건
